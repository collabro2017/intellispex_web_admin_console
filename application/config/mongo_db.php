...
$config['mongo_db']['default']['hostname'] = 'mdb-27.business-applicati.7488.mongodbdns.com';
$config['mongo_db']['default']['port'] = '27000';
$config['mongo_db']['default']['username'] = 'blakedratcliff@gmail.com';
$config['mongo_db']['default']['password'] = 'Blake052384#!!';
$config['mongo_db']['default']['database'] = 'icymi';
