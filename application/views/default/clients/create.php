                                ...
                                <?php if (isset($create_client)): ?>
                                    ...
                                    <?php if (isset($edit_client)): ?>
                                        ...
                                        <table class="table table-striped create-client-table" style="margin: 0px;max-width: 85%;"> 
                                            <tr>
                                                <th>Client Name</th>
                                                <th><input type="text" class="span6" name='name' <?php if (isset($client_data[0]['username'])): ?> value="<?php echo $client_data[0]['username']; ?>" <?php endif; ?>/></th>
                                            </tr>
                                            <tr>
                                                <td>Email</td>
                                                <td><input type="text" class="span6" name='email'<?php if (isset($client_data[0]['email'])): ?> value="<?php echo $client_data[0]['email']; ?>" <?php endif; ?>/></td>
                                            </tr>
                                            <tr>
                                                <td>Password</td>
                                                <td><input type="password" class="span6" name='password'<?php if (isset($client_data[0]['password'])): ?> value="<?php echo $client_data[0]['password']; ?>" <?php endif; ?>/></td>
                                            </tr>
<!--										<tr>
                                              <td>Location</td>
