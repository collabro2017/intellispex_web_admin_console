        ...
        <div class="row-fluid">
          <div class="span12">
            ...
            <div class="login-container">
              ...
              <div class="row-fluid">
                <div class="center">
                  <h1><img class="irc_mut iUyhD38Z_yik-HwpH6ZlgJaI" onload="google.aft&amp;&amp;google.aft(this)" src="<?php echo base_url('public') ?>/images/logo.JPG" width="60" height="60" style="margin-top: 0px;"> <span class="red">IntelliSpeX RESET CLIENT PASSWORD</span></h1>
                </div>
              </div>
