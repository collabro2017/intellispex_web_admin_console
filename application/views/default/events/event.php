                                ...
                                <div class="span8">
                                    ...
                                    <div class="span12">
                                        ...
                                        if (isset($event->thumbImage) && isset($event->postImage)) {
                                            ...
                                            ?>
                                            <div style="background-size: 100% 100% !important;padding:20px; background: url('<?php echo $imagePost->url; ?>'); width:80%; margin:auto;min-height: 400px;">
                                                <div style="min-height: 300px; background: #FFF;opacity: 0.5;padding: 10px;padding-left: 20px;padding-top: 30px; width: 50%; margin: auto;text-align: center;">
                                                ...
                                                <?php if (isset($event->startTime)){ ?>
                                                        <p style="font-size:16px">Time Start</p>
                                                        <p style="font-size:16px"><?php echo $event->startTime; ?></p>
                                                <?php } ?>
                                                <?php if (isset($event->endTime)){ ?>
                                                        <p style="font-size:16px">Time End</p>
                                                    <p style="font-size:16px"><?php echo $event->endTime; ?></p>
                                                <?php } ?>
                                                ...
                                                <ul style="position: relative; bottom: -54px; background: #FFF;opacity: 0.7;width: 111px;height: 38px;border-radius: 3px;">
                                                ...
                                                if (count($event_comment)) {
                                                    foreach ($event_comment as $data) {
                                                        ...
                                                        <div style="float:left">
                                                            <span style="color: #444"><?php echo date('d-m-Y g:i A', strtotime($data->createdAt)) . ": "; ?></span>
                                                            <b>
                                                                <?php
