...
<html lang="en">
    ...
    <body class="login-layout admin-body">
        <div class="widget-main">
            <div class="top-menu">
                <h2 class="span3"><img class="irc_mut iUyhD38Z_yik-HwpH6ZlgJaI" onload="google.aft & amp; & amp;google.aft(this)" src="<?php echo base_url('public') ?>/images/logo.JPG" width="60" height="60" style="margin-top: 0px;"> <span style="color : #00aaff;">ICYMI</span></h2>
...
<?php if (isset($client_setup)):
    ...
    <?php foreach ($client as $value): ?>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <select>
                                                                                    <option value="0" disabled <?php if ($value['Status'] == '') {
            echo "selected";
        } ?>></option>
                                                                                    <option value="True" <?php if ($value['Status'] == '1') {
            echo "selected";
        } ?>>Active</option>
                                                                                    <option value="False" <?php if ($value['Status'] == '0') {
            echo "selected";
        } ?>>Closed</option>
                                                                                </select>
                                                                            </td>
